...
/// @DnDVersion : 1
/// @DnDHash : 4A920622
/// @DnDArgument : "funcName" "scr_characterAttack3"
function scr_characterAttack3() 
{
	...
	if (l5CD1A817_0)
	{
		...
		if(!l11616FED_0)
		{
			...
			if(!l389CF38B_0)
			{
				...
				/// @DnDArgument : "spriteind" "CharacterSpearLeft"
				sprite_index = CharacterSpearLeft;
				image_index += 0;
			}
		...
		/// @DnDHash : 1FAA0F23
		/// @DnDParent : 5CD1A817
		/// @DnDArgument : "xpos" "-145"
		/// @DnDArgument : "xpos_relative" "1"
		/// @DnDArgument : "ypos" "-30"
		/// @DnDArgument : "ypos_relative" "1"
		/// @DnDArgument : "objectid" "SwingHitboxLeft"
		instance_create_layer(x + -145, y + -30, "Instances", SwingHitboxLeft);
	}
	...
	if (l0B88D5C8_0)
	{
		...
		if(!l15B4B807_0)
		{
			...
			if(!l3FED65D5_0)
			{
				...
				/// @DnDParent : 3FED65D5
				/// @DnDArgument : "imageind_relative" "1"
				/// @DnDArgument : "spriteind" "CharacterSpearRight"
				sprite_index = CharacterSpearRight;
				image_index += 0;
			}
		...
		/// @DnDHash : 19B2BA30
		/// @DnDParent : 0B88D5C8
		/// @DnDArgument : "xpos" "110"
		/// @DnDArgument : "xpos_relative" "1"
		/// @DnDArgument : "ypos" "-30"
		/// @DnDArgument : "ypos_relative" "1"
		/// @DnDArgument : "objectid" "SwingHitboxRight"
		instance_create_layer(x + 110, y + -30, "Instances", SwingHitboxRight);
	}
	...
	if (l1DF692B8_0)
	{
		...
		if(!l0CC47700_0)
		{
			...
			if(!l16DBD2CE_0)
			{
				...
				/// @DnDParent : 16DBD2CE
				/// @DnDArgument : "imageind_relative" "1"
				/// @DnDArgument : "spriteind" "CharacterSpearUp"
				sprite_index = CharacterSpearUp;
				image_index += 0;
			}
		...
		instance_create_layer(x + -30, y + -100, "Instances", SwingHitboxUp);
	}
	...
	if (l77436749_0)
	{
		...
		if(!l528DC77D_0)
		{
			...
			if(!l34F975E8_0)
			{
				...
				/// @DnDParent : 34F975E8
				/// @DnDArgument : "imageind_relative" "1"
				/// @DnDArgument : "spriteind" "CharacterSpearDown"
				sprite_index = CharacterSpearDown;
				image_index += 0;
			}
		...
		instance_create_layer(x + -30, y + 80, "Instances", SwingHitboxDown);
	}
}