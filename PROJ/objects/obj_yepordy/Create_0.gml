...
yepordy_set_category(3,"Past Experiences")
...
yepordy_set_question(0,2,"What's the Wintery thing to do outside in Florida?","There's like no shit here so just go look at Christmas lights bro.")
yepordy_set_question(0,3,"When is Kwanzaa this year?","December 26th to January 1st.")
yepordy_set_question(0,4,"What is the Christmas gift I recieved in 2019?","The PC in my room.")
