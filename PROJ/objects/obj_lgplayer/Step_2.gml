...
while place_meeting(x, y + abs(hspeed) + 1, obj_LGslope) && !place_meeting(x, y + 1, obj_LGslope) && !jumping && !dashing && state != playerstate.hurt && state != playerstate.dying && grav = 1
{
	y += 0.1
}
