...
switch state
{
	...
	{
		if !place_meeting(x,y,obj_waterhitbox)
		{
			lamptimer = 0
			image_index = 1
			image_speed = 0
			sprite_index = spr_possessable_chocosub
...
#region up arrow
if (place_meeting(x,y,obj_npc) || place_meeting(x,y,obj_jukebox)) && controllable && possessed_object = noone
{
