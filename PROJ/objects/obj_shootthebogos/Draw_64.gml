...
if bogos_hit
	draw_sprite_ext(spr_bogos_shot,bogos_hitindex,bogos_x - 4,bogos_y + 4,1,1,image_angle,c_black,0.4)
else
	draw_sprite_ext(sprite_index,image_index,bogos_x - 4,bogos_y + 4,1,1,image_angle,c_black,0.4)
