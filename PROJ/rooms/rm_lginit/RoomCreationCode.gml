...
//loading
audio_group_load(audio_sound_lg)
audio_group_load(audio_music_lg)
...
audio_group_set_gain(audio_music_lg,mu_vol,0)
...
//if ini_read_real("settings","fullscreen",0)
