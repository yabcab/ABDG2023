...
/// @DnDVersion : 1
/// @DnDHash : 75804344
/// @DnDArgument : "funcName" "Scr_CharacterMoveLeft"
function Scr_CharacterMoveLeft() 
{
	...
	if(l6DE0D7E6_0)
	{
		...
		if(l08C7B7FD_0)
		{
			...
			/// @DnDParent : 08C7B7FD
			/// @DnDArgument : "imageind_relative" "1"
			/// @DnDArgument : "spriteind" "CharacterWalkLeftBoost"
		...
		if(l51EFDD0D_0)
		{
			...
			if(!l09654E57_0)
			{
				...
				if(!l1E14AA80_0)
				{
					...
					/// @DnDParent : 1E14AA80
					/// @DnDArgument : "imageind_relative" "1"
					/// @DnDArgument : "spriteind" "CharacterAvoWalkLeftBoost"
		...
		if(!l15CF2C35_0)
		{
			...
			if(l03988303_0)
			{
				...
				if(!l554E9B4C_0)
				{
					...
					/// @DnDParent : 554E9B4C
					/// @DnDArgument : "imageind_relative" "1"
					/// @DnDArgument : "spriteind" "CharacterSpingeWalkLeftInv"
		...
		if(l7321E890_0)
		{
			...
			if(!l0F784197_0)
			{
				...
				if(!l13B76585_0)
				{
					...
					/// @DnDParent : 13B76585
					/// @DnDArgument : "imageind_relative" "1"
					/// @DnDArgument : "spriteind" "CharacterSpingeWalkLeftBoost"
